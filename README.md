...
| --- | ---: | --- | --- |
| Venture operations | 12 | [`cambium`](https://github.com/Sheshiyer/cambium), [`team-forge-ts`](https://github.com/Sheshiyer/team-forge-ts), [`temperance_engine`](https://github.com/Sheshiyer/temperance_engine), [`snow-gloves-os`](https://github.com/Sheshiyer/snow-gloves-os) | Taste, planning, execution, and review stay in the same loop. |
| Reflection runtimes | 16 | [`tpothp`](https://github.com/Sheshiyer/tpothp), [`urania-137`](https://github.com/Sheshiyer/urania-137), [`webshore-witnessos-aleph`](https://github.com/Sheshiyer/webshore-witnessos-aleph), [`Selemene-engine`](https://github.com/Sheshiyer/Selemene-engine) | Symbolic work is kept runnable, inspectable, and grounded in code. |
| Spatial systems | 11 | [`spatial-anubis-noesis`](https://github.com/Sheshiyer/spatial-anubis-noesis), [`marina1-k`](https://github.com/Sheshiyer/marina1-k), [`panorama-viewer-marina-beta`](https://github.com/Sheshiyer/panorama-viewer-marina-beta), [`vantyx`](https://github.com/Sheshiyer/vantyx) | Place is treated as interface: mapped, navigable, and operational. |
| Trust surfaces | 13 | [`tirak-backend-alpha01`](https://github.com/Sheshiyer/tirak-backend-alpha01), [`tirak-website-v1`](https://github.com/Sheshiyer/tirak-website-v1), [`fitcheck-landing`](https://github.com/Sheshiyer/fitcheck-landing), [`wikiv2-tirakapp`](https://github.com/Sheshiyer/wikiv2-tirakapp) | Trust surfaces carry consent, verification, and cultural context. |
| Narrative archives | 21 | [`somatic-canticles-v3-book-trilogy`](https://github.com/Sheshiyer/somatic-canticles-v3-book-trilogy), [`synchronocities-blog`](https://github.com/Sheshiyer/synchronocities-blog), [`somatic-canticles-bm-wiki`](https://github.com/Sheshiyer/somatic-canticles-bm-wiki), [`wtfmedia`](https://github.com/Sheshiyer/wtfmedia) | Archives hold story, research, media, and ritual without flattening them. |
| Toolmaking | 99 | [`plexus-ts`](https://github.com/Sheshiyer/plexus-ts), [`brahma13x19darshanam`](https://github.com/Sheshiyer/brahma13x19darshanam), [`10865xseed`](https://github.com/Sheshiyer/10865xseed), [`kacima-new`](https://github.com/Sheshiyer/kacima-new) | Expert workflows become portable without shaving off the practice. |
...
| [`tirak-backend-alpha01`](https://github.com/Sheshiyer/tirak-backend-alpha01) | Trust surfaces | TypeScript | Public work surface. |
...
| [`tpothp`](https://github.com/Sheshiyer/tpothp) | Reflection runtimes | HTML | Public TPoTHP production assets for Tryambakam Noesis |
